...
class ProductEntry(Base):
    ...
    primary_category = Column(String(100), default="", index=True)
    secondary_categories_json = Column(Text, default="[]")
    normalized_brand = Column(String(100), default="", index=True)
    normalized_space = Column(String(100), default="", index=True)
    normalized_style = Column(String(100), default="", index=True)
    normalized_color = Column(String(100), default="", index=True)
    normalized_materials_json = Column(Text, default="[]")
    category_confidence = Column(Float, default=0.0)
    classification_source = Column(String(100), default="")
