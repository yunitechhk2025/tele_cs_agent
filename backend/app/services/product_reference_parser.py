...
_ABSOLUTE_WORDS = {
    1: [
        "第一", "第一个", "第一個", "第一款", "第一件", "第一号", "第一號", "头一个", "頭一個",
        "first", "1st", "primero", "primera", "primer", "premier", "premiere",
        "一番目", "一つ目", "ひとつ目", "最初", "첫번째", "첫 번째",
    ],
    2: [
        "第二", "第二个", "第二個", "第二款", "第二件", "第二号", "第二號",
        "second", "2nd", "segundo", "segunda", "deuxieme", "second", "seconde",
        "二番目", "二つ目", "ふたつ目", "두번째", "두 번째",
    ],
    3: [
        "第三", "第三个", "第三個", "第三款", "第三件", "第三号", "第三號",
        "third", "3rd", "tercero", "tercera", "tercer", "troisieme",
        "三番目", "三つ目", "みっつ目", "세번째", "세 번째",
    ],
    4: [
        "第四", "第四个", "第四個", "第四款", "fourth", "4th", "cuarto", "cuarta",
        "quatrieme", "四番目", "四つ目", "네번째", "네 번째",
    ],
    5: [
        "第五", "第五个", "第五個", "第五款", "fifth", "5th", "quinto", "quinta",
        "cinquieme", "五番目", "五つ目", "다섯번째", "다섯 번째",
    ],
    6: [
        "第六", "第六个", "第六個", "第六款", "sixth", "6th", "sexto", "sexta",
        "sixieme", "六番目", "六つ目", "여섯번째", "여섯 번째",
    ],
    7: [
        "第七", "第七个", "第七個", "第七款", "seventh", "7th", "septimo", "septima",
        "septieme", "七番目", "七つ目", "일곱번째", "일곱 번째",
    ],
    8: [
        "第八", "第八个", "第八個", "第八款", "eighth", "8th", "octavo", "octava",
        "huitieme", "八番目", "八つ目", "여덟번째", "여덟 번째",
    ],
    9: [
        "第九", "第九个", "第九個", "第九款", "ninth", "9th", "noveno", "novena",
        "neuvieme", "九番目", "九つ目", "아홉번째", "아홉 번째",
    ],
}

_LAST_PHRASES = [
    "最后", "最後", "末尾", "last", "last one", "ultimo", "ultima",
    "dernier", "derniere", "最後の商品", "마지막", "마지막 제품",
]
_SECOND_FROM_END_PHRASES = [
    "second to last", "second last", "second from last", "penultimate",
    "penultimo", "penultima", "avant dernier", "avant derniere", "penultieme",
]
_THIRD_FROM_END_PHRASES = [
    "third to last", "third last", "third from last", "antepenultimate",
    "antepenultimo", "antepenultima", "antepenultieme",
]
_MIDDLE_PHRASES = [
    "中间", "中間", "middle", "middle one", "del medio", "el del medio", "la del medio",
    "du milieu", "celui du milieu", "celle du milieu", "真ん中", "真ん中の商品",
    "가운데", "가운데 제품",
]
_PREVIOUS_PHRASES = [
    "上一个", "上一個", "前一个", "前一個", "previous", "previous one", "anterior",
    "precedent", "precedente", "前の商品", "이전", "이전 제품",
]
_NEXT_PHRASES = [
    "下一个", "下一個", "后一个", "後一個", "next", "next one", "siguiente",
    "suivant", "suivante", "次の商品", "다음", "다음 제품",
]
_FORMER_PHRASES = ["前者", "former", "the former"]
_LATTER_PHRASES = ["后者", "後者", "latter", "the latter"]
_ACTIVE_REFERENCE_PHRASES = [
    "这个", "這個", "这款", "這款", "这件", "這件", "这个产品", "這個產品", "它",
    "this one", "this product", "it",
    "este producto", "este", "ese producto",
    "ce produit", "celui ci", "celui la",
    "この商品", "その商品", "これ", "それ",
    "이 제품", "그 제품", "이것", "그것",
]
_ACTION_CONTEXT_PHRASES = [
    "show me", "see", "generate", "living room", "room", "style", "styled", "scene",
    "ver", "muestrame", "mostrar", "salon", "sala", "estilo",
    "montre", "voir", "salon", "style",
    "看看", "生成", "效果图", "客厅", "風格", "风格",
    "見たい", "リビング", "スタイル",
    "보고", "거실", "스타일",
]
...
def normalize_reference_text(value: Any) -> str:
    ...
    without_marks = unicodedata.normalize("NFC", "".join(
...
def _relative_slot(kind: str, item_count: int | None, *, offset: int | None = None, current_slot: int | None = None) -> int | None:
    if kind == "from_end":
...
def _result(
    *,
    ...
    return ProductReferenceResult(
        ...
        is_selection_only=_selection_only(spaced, compact, bool(slot or relative_kind or is_active_product_reference)),
...
def _parse_from_end(spaced: str, compact: str, item_count: int | None) -> tuple[int | None, int | None, str]:
    ...
    kr_match = re.search(r"뒤에서([1-9]|첫|한|하나|두|둘|세|셋|네|넷|다섯|여섯|일곱|여덟|아홉)(?:번째|번)", compact)
    if kr_match:
