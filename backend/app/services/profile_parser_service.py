...
async def parse_product_request_profile(
    ...
    *,
    ...
    prompt = (
        ...
        "Do NOT inherit colors, spaces, styles, materials, or brands from conversation memory for a new product recommendation "
        "unless the latest user message explicitly repeats that constraint.\n"
