...
PRODUCT_CATEGORY_TERMS = {
    "sofa": ["沙发", "沙發", "贵妃", "躺椅", "sofa", "couch", "sectional", "recliner", "loveseat", "ソファ", "ソファー", "カウチ", "소파", "쇼파", "canape", "divan"],
    ...
    "cabinet": ["储物柜", "儲物櫃", "收纳柜", "收納櫃", "边柜", "邊櫃", "斗柜", "斗櫃", "柜", "櫃", "cabinet", "storage cabinet", "commode", "dresser", "aparador", "armario", "buffet", "rangement", "キャビネット", "収納", "수납장", "서랍장"],
    ...
    "chair": ["休闲椅", "单椅", "椅子", "椅", "chair", "armchair", "silla", "fauteuil", "chaise", "チェア", "의자"],
...
SPACE_TERMS = {
    "living_room": ["客厅", "客廳", "起居室", "living room", "sala", "sala de estar", "salon", "リビング", "居間", "거실"],
    "dining_room": ["餐厅", "餐廳", "饭厅", "飯廳", "dining room", "comedor", "salle a manger", "ダイニング", "食堂", "식당", "다이닝룸"],
    "bedroom": ["卧室", "臥室", "主卧", "主臥", "bedroom", "dormitorio", "chambre", "寝室", "ベッドルーム", "침실"],
    "study": ["书房", "書房", "办公室", "辦公室", "study", "office", "bureau", "estudio", "書斎", "オフィス", "서재", "사무실"],
    "entryway": ["玄关", "玄關", "门厅", "門廳", "entryway", "foyer", "entree", "recibidor", "玄関", "현관"],
}

STYLE_TERMS = {
    "modern": ["现代", "現代", "现代简约", "現代簡約", "modern", "contemporary", "moderno", "moderne", "モダン", "현대", "모던"],
    "minimalist": ["极简", "極簡", "简约", "簡約", "minimalist", "minimal", "minimale", "minimalista", "ミニマル", "シンプル", "미니멀", "심플"],
    "luxury": ["轻奢", "輕奢", "高端", "奢华", "奢華", "luxury", "premium", "lujo", "lujoso", "luxe", "ラグジュアリー", "高級", "럭셔리", "고급"],
    ...
    "japanese": ["日式", "原木风", "原木風", "japanese", "japandi", "japones", "japonais", "和風", "日本風", "일본식"],
    "vintage": ["复古", "復古", "中古", "retro", "vintage", "clasico", "classique", "レトロ", "ヴィンテージ", "복고", "빈티지"],
    "french": ["法式", "french", "frances", "francais", "フレンチ", "프렌치"],
    "italian": ["意式", "italian", "italiano", "italien", "イタリアン", "이탈리안"],
}

COLOR_TERMS = {
    "white": ["白色", "米白", "奶油", "象牙", "白", "ivory", "white", "cream", "blanco", "blanca", "blanc", "blanche", "白い", "ホワイト", "흰색", "하얀", "화이트"],
    "black": ["黑色", "雅黑", "黑", "black", "negro", "noir", "黒", "ブラック", "검정", "검은색", "블랙"],
    "gray": ["灰色", "银灰", "銀灰", "灰", "grey", "gray", "gris", "グレー", "회색", "그레이"],
    "brown": ["棕色", "咖啡", "褐色", "棕", "brown", "cafe", "marron", "brun", "ブラウン", "茶色", "갈색", "브라운"],
    "wood": ["原木", "木色", "胡桃", "柚木", "樱桃木", "櫻桃木", "walnut", "teak", "cherry wood", "wood", "madera", "bois", "木目", "ウッド", "원목", "월넛"],
    "red": ["红色", "紅色", "酒红", "酒紅", "红", "紅", "red", "rojo", "rouge", "赤", "レッド", "빨간", "빨강", "레드"],
    "blue": ["蓝色", "藍色", "蓝", "藍", "blue", "azul", "bleu", "青", "ブルー", "파란", "파랑", "블루"],
    "green": ["绿色", "綠色", "绿", "綠", "green", "verde", "vert", "緑", "グリーン", "초록", "녹색", "그린"],
    "purple": ["紫色", "紫", "purple", "violet", "morado", "morada", "violeta", "violette", "パープル", "보라", "보라색", "퍼플"],
    "pink": ["粉色", "粉", "pink", "rosa", "rose", "ピンク", "분홍", "핑크"],
    "yellow": ["黄色", "黃色", "黄", "黃", "yellow", "amarillo", "jaune", "イエロー", "노랑", "옐로우"],
    "beige": ["米色", "杏色", "卡其", "beige", "khaki", "arena", "ベージュ", "베이지"],
}

MATERIAL_TERMS = {
    "leather": ["真皮", "牛皮", "皮质", "皮質", "皮", "leather", "piel", "cuero", "cuir", "革", "レザー", "가죽"],
    "fabric": ["布艺", "布藝", "布", "绒", "絨", "fabric", "cloth", "tela", "textil", "tissu", "ファブリック", "패브릭", "원단"],
    "solid_wood": ["实木", "實木", "原木", "solid wood", "madera maciza", "bois massif", "無垢材", "木製", "원목"],
    "walnut": ["胡桃", "黑胡桃", "walnut", "nogal", "noyer", "ウォールナット", "월넛"],
    "teak": ["柚木", "teak", "teca", "teck", "チーク", "티크"],
    "stone": ["岩板", "大理石", "石", "slate", "marble", "stone", "piedra", "marbre", "セラミック", "암판", "대리석"],
...
CATEGORY_EXCLUSION_TERMS = {
    "sofa": ["沙发背柜", "沙發背櫃", "沙发柜", "沙發櫃", "沙发背几", "沙發背幾", "sofa back cabinet", "sofa console"],
    "desk": ["书桌椅", "書桌椅", "办公椅", "辦公椅", "书房椅", "書房椅", "desk chair", "office chair", "study chair"],
...
def canonicalize_value(dimension: str, value: Any) -> str:
    ...
    for key, terms in table.items():
        if normalized == normalize_text(key) or normalized in {normalize_text(term) for term in terms}:
            return key
    return ""
...
def product_category_values(product: dict[str, Any]) -> list[str]:
    ...
    secondary = parse_json_list(product.get("secondary_categories") or product.get("secondary_categories_json"))
...
def match_normalized_product_value(product: dict[str, Any], dimension: str, value: str) -> bool | None:
...
def infer_primary_category(product: dict[str, Any]) -> tuple[str, float, str]:
    category_text = _joined_product_text(
        product,
        ("category", "name", "product_name", "series", "series_name", "space", "description", "description_text"),
    )
...
def _infer_materials(product: dict[str, Any]) -> list[str]:
    text = _joined_product_text(product, ("material", "description", "description_text", "detail_content", "detail_content_text"))
    out: list[str] = []
...
def infer_product_metadata(product: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "normalized_space": _infer_first_dimension(product, "spaces", ("space", "name", "product_name", "series", "series_name", "description", "description_text")),
        "normalized_style": _infer_first_dimension(product, "styles", ("style", "name", "product_name", "series", "series_name", "description", "description_text")),
        "normalized_color": _infer_first_dimension(product, "colors", ("color", "name", "product_name", "series", "series_name", "description", "description_text")),
...
def apply_inferred_metadata(fields: dict[str, Any]) -> dict[str, Any]:
    ...
    enriched.update({
        ...
        "secondary_categories_json": json.dumps(metadata["secondary_categories"], ensure_ascii=False),
        ...
        "normalized_materials_json": json.dumps(metadata["normalized_materials"], ensure_ascii=False),
